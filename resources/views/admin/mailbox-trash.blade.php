                    ...
                    <div class="col-md-3">
                        <div class="email-sidebar white_box">
                            ...
                            <ul class="text-left mt-2">
                                <li><a href="{{('message_center')}}"><i class="ti-user"></i> <span> <span>Inbox</span> </span> </a></li>

                                <li><a href="{{('sent_mails')}}"><i class="ti-announcement"></i> <span> <span>Sent Mails</span></span> </a></li>

                                <li class="active"><a href="mailbox_trash"><i class="ti-trash"></i> <span> <span>Trash</span> </span> </a></li>
