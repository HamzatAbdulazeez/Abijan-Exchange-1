            ...
            <div class="row justify-content-center">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="page_title_left mb_30">
                                    <h3>Admin Support Sent Mails</h3>
                                </div>
                            </div>
                            <div class="col-lg-6">
                ...
                <div class="col-md-9">
                    <div class="white_box QA_section mb_30">
                        ...
                        <div class="QA_table">
                            <!-- table-responsive -->
                            <a href="javascript: void(0)" class="deletTop inbox" title="Delete message"><p class=""> <i class="ti-trash"></i> Delete</p></a><a href="javascript: void(0)" class="restoreTop inbox" title="Archive message"><p class="">  <i class="ti-briefcase"></i> Archive</p></a><div id="DataTables_Table_0_wrapper" class="dataTables_wrapper no-footer"><div id="DataTables_Table_0_filter" class="dataTables_filter"><label><i class="ti-search"></i><input type="search" class="" placeholder="Quick Search" aria-controls="DataTables_Table_0"></style='display:none'></label></div><table class="table readMsgTable dataTable no-footer dtr-inline" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info" style="width: 835px;">
                                <thead>
                                            
                                            
                                            
                                            
                                    <tr role="row"><th scope="col" class="sorting_disabled" rowspan="1" colspan="1" style="width: 86px;"><label class="primary_checkbox d-flex mr-12 selectDelete1">
                                                <input type="checkbox" id="checkboxAll">
                                                <span class="checkmark" title="Select" id="checkboxmsgAll"></span>
                                            </label></th><th scope="col" class="sorting_disabled" rowspan="1" colspan="1" style="width: 171px;">Message</th><th scope="col" class="sorting_disabled" rowspan="1" colspan="1" style="width: 177px;">Category</th><th scope="col" class="sorting_disabled" rowspan="1" colspan="1" style="width: 111px;">Date</th><th scope="col" class="sorting_disabled" rowspan="1" colspan="1" style="width: 138px;">status</th></tr>
                                </thead>
                                <tbody>
                                                                    
                                <tr class="odd"><td valign="top" colspan="5" class="dataTables_empty">Your messages will appear here.</td></tr></tbody>
                            </table><div class="dataTables_info" id="DataTables_Table_0_info" role="status" aria-live="polite">Showing 0 to 0 of 0 messages</div><div class="dataTables_paginate paging_simple_numbers" id="DataTables_Table_0_paginate"><a class="paginate_button previous disabled" aria-controls="DataTables_Table_0" data-dt-idx="0" tabindex="0" id="DataTables_Table_0_previous"><i class="ti-arrow-left"></i></a><span></span><a class="paginate_button next disabled" aria-controls="DataTables_Table_0" data-dt-idx="1" tabindex="0" id="DataTables_Table_0_next"><i class="ti-arrow-right"></i></a></div></div>
