                                ...
                                <div class="box_header m-0">
                                    <div class="main-title">
                                        ...
                                        <ul class="nav nav-pills custom_bootstrap_nav">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link active" href="#nairadiv" data-toggle="tab"> Deposit Naira</a>
                                            </li>
                                            <li class="nav-item">
                                    ...
                                    <div class="exchange_widget">
                                        <div class="form-group" id="bankacctdiv">
                                            ...
                                            <div class="input-group ">
                                                <select name="deposit_method" id="deposit_method" class="form-control nice_Select" style="display: none;">

                                                    <option value="">Verify your identity to deposit money</option>
                                                </select>
                                                <div class="nice-select form-control nice_Select" tabindex="0"><span class="current">Verify your identity to deposit money</span>
                                                    <div class="nice-select-search-box"><input type="text" class="nice-select-search" placeholder="Search..."></div>
                                                    <ul class="list">
                                                        <li data-value="" class="option selected">Verify your identity to deposit money</li>
                                                    </ul>
                                                </div>
                            ...
                            <div class="accordion accordion_custom mb_50" id="accordion_ex">
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion_ex">
                                        <div class="card-body">
                                            <p>No, We don't accept third party bank transfer so you can only make payment from your own personal bank account.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    ...
                                    <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion_ex">
                                        <div class="card-body">
                                            <p>Once you complete the form on this page, a deposit instruction would be sent to your email address. </p>
