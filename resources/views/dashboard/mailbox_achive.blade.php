                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="dashboard_breadcam text-right">
                                            <p><a href="/dashboard">Dashboard</a> <i class="fas fa-caret-right"></i> Mailbox
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-3">
                            <div class="email-sidebar white_box">
                                ...
                                <ul class="text-left mt-2">
                                    <li><a href="{{ route('mailbox.inbox') }}"><i class="ti-user"></i> <span>
                                                <span>Inbox</span> </span> </a></li>

                                    <li><a href="{{ route('mailbox.sent') }}"><i class="ti-announcement"></i> <span>
                                                <span>Sent
                                                    Mails</span></span> </a></li>

                                    <li><a href="{{ route('mailbox.trash') }}"><i class="ti-trash"></i> <span>
                                                <span>Trash</span> </span> </a></li>

                                    <li class="active"><a href="{{ route('mailbox.archive') }}"><i class="ti-briefcase"></i>
                                            <span>
                                                <span>Archive</span> </span> </a></li>
                                ...
                                <div class="QA_table">
                                    ...
                                    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper no-footer">
                                        <div id="DataTables_Table_0_filter" class="dataTables_filter"><label><i
                                                    class="ti-search"></i>
                                                <style='display:none'><input type="search" class=""
                                        ...
                                        <table class="table readMsgTable dataTable no-footer dtr-inline"
                                            ...
                                            aria-describedby="DataTables_Table_0_info" style="width: 712px;">
                                            <thead>
                                                ...
                                                <tr role="row">
                                                    <th scope="col" class="sorting_disabled" rowspan="1"
                                                        colspan="1" style="width: 69px;"><label
                                                    ...
                                                    <th scope="col" class="sorting_disabled" rowspan="1"
                                                        colspan="1" style="width: 113px;">status</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @if ($sent->count() > 0)
                                                @foreach ($sent as $item)
                                                    <tr role="row" class="odd">
                                                        <td scope="row" tabindex="0">
                                                            ...
                                                            <input type="checkbox" class="checkboxmsg" id="{{$item->id}}">
                                                            <span class="checkmark"></span>
                                                            </label>
                                                        </td>
                                                        <td>
                                                            <p class="readMsgFn  {{$item->id}}" style="cursor: pointer;" data-value="{{$item->id}}">{{$item->message}} </p>
                                                        </td>
                                                        <td>
                                                            <div class="media align-items-center">
                                                            <div class="media-body">
                                                                <p class="readMsgFn  {{$item->id}}" style="cursor: pointer;" data-value="{{$item->id}}">{{$item->subject}}</p>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <p class="readMsgFn  {{$item->id}}" style="cursor: pointer;" data-value="{{$item->id}}">  {{\Carbon\Carbon::parse($item->created_at)->diffForHumans()}}</p>
                                                        </td>
                                                        <td>
                                                            <p class="readMsgFn  {{$item->id}}" style="cursor: pointer;" data-value="{{$item->id}}">
                                                                @if ($item->status == 0)
                                                                    Unread
                                                                @else
                                                                    Read
                                            ...
                                            @else
                                                <tr class="odd">
                                                    <td colspan="5" class="dataTables_empty" valign="top">Your
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12" style="display:none1">
                                    <div class="common_input mb_20">
                                        ...
                                        <button type="button" id="replybtnMsg" class="btn_1 w-100 col-md-5"><i class="ti-arrow-top-left"></i> Reply</button> <span class="col-md-2"></span><button type="submit" class="btn_2 w-100 col-md-5" id="deletebtnMsg"><i class="ti-trash"></i>
