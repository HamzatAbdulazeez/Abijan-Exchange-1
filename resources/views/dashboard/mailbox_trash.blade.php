...
@section('page-content')
    ...
    <div class="layout-container">
        ...
        <div class="layout-content">
                        ...
                        <div class="col-md-3">
                            <div class="email-sidebar white_box">
                                ...
                                <ul class="text-left mt-2">
                                    ...
                                    <li class="active"><a href="{{ route('mailbox.trash') }}"><i class="ti-trash"></i>
                                            <span>
                                                <span>Trash</span> </span> </a></li>

                                    <li><a href="{{ route('mailbox.archive') }}"><i class="ti-briefcase"></i> <span>
                                                        ...
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td>
                                                                <p class="readMsgFn  {{ $item->id }}"
                                                                    ...
                                                                    data-value="{{ $item->id }}">{{ $item->message }}
                                                                </p>
                                                            </td>
                                                            <td>
            ...
            <div class="modal fade" id="readMsgModalCenter" tabindex="-1" role="dialog"
                aria-labelledby="readMsgModalCenterTitle" aria-hidden="true">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12" style="display:none1">
                                    <div class="common_input mb_20">
                                        ...
                                        <button type="button" id="replybtnMsg" class="btn_1 w-100 col-md-5"><i
                                                class="ti-arrow-top-left"></i> Reply</button>
                                        <span class="col-md-2"></span><button type="submit" class="btn_2 w-100 col-md-5"
                                            id="deletebtnMsg"><i class="ti-trash"></i>
