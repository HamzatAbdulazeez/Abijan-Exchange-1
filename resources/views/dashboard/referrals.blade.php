                                    ...
                                    <div class="box_header m-0">
                                        <div class="main-title">
                                            ...
                                            <ul class="nav nav-pills custom_bootstrap_nav">
                                                <li class="nav-item">
                                                    <a class="nav-link active" href="#invitedusersdiv"
                                                        data-toggle="tab">Invited Users</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="#earningsdiv" data-toggle="tab"> Your
                                                        Earnings</a>
                                                </li>
                                                <!-- <li class="nav-item">
                                    ...
                                    <div class="white_card_body tab-pane fade active show" id="invitedusersdiv">
                                        <div class="exchange_widget">
                                            ...
                                            <div class="form-group" id="walletdiv">
                                                <span>Help us invite new people to use Abijan Exchange and receive free
                                                    money as a reward!</span>

                                                <!-- <br><br> -->

                                                <div class="bitcoin-address-container white_top"
                                                    data-bc-address="210255314">
                                                    @php
                                                        $refer = \App\Models\User::where('referred_by', Auth::user()->affiliate_id)->get();
                                                    @endphp
                                                    <div class="walletaddy">
                                                        <div>Total Invited Users</div>
                                                        <span class="bitcoin-address bitcoin-address-controls"
                                                            id="busers">{{$refer->count()}}</span>
                                                    </div>
                                                    ...
                                                    <div class="walletaddy">
                                                        @if(Auth::user()->affiliate_id)
                                                            <div>Referral Link
                                                                <span>
                                                                    <button
                                                                        class="btn btn-default mb-3 bitcoin-address-action bitcoin-address-action-copy"
                                                                        type="button" title="Copy Link" data-info="brefLink">
                                                            ...
                                                            <b class="receive-address">
                                                                <span
                                                                    class="bitcoin-address bitcoin-address-controls brefLink"
                                                                    id="brefLink">{{url('/').'/register?ref='.Auth::user()->affiliate_id}}
                                                                </span>
                                                            </b>
                                                        @endif
                                                    </div>
                                                    ...
                                                    <b class="receive-address"><span
                                                            class="bitcoin-address bitcoin-address-controls brefID"
                                                            id="brefID">{{Auth::user()->affiliate_id}} <button
                                                                class="btn btn-default mb-3 bitcoin-address-action bitcoin-address-action-copy"
                                                                type="button" title="Copy referral ID" data-info="brefID">
                                                                <i class="far fa-copy"></i></button></span></b>
                                    ...
                                    <div class="white_card_body tab-pane fade" id="earningsdiv">
                                        <div class="white_card1 mb_30 card_height_100">
                                            <div class="walletaddy">
                                                ...
                                                <b class="receive-address"><span
                                                        class="bitcoin-address bitcoin-address-controls bwallet1"
                                                        id="bwallet"><button
                                                            class="btn btn-outline-info rounded-pill mb-3 bitcoin-address-action bitcoin-address-action-copy"
                                                            type="button"> 0 NGN</button></span></b>
                                                ...
                                                <div class="QA_section">
                                                    <div class="QA_table mb-30 transaction-table">
                                                        ...
                                                        <div class="responsive">
                                                            <p>No Earnings yet</p>
                                                            <table class="table lms_table_active3s responsive">
                                ...
                                <div class="accordion accordion_custom mb_50" id="accordion_ex">
                                    <div class="card">
                                        ...
                                        <div id="collapseOne" class="collapse" aria-labelledby="headingOne"
                                            ...
                                            <div class="card-body">
                                                <p>You earn money when the person you refer buys or sells any ecurrency (or
                                                    crypto).</p>
                                            </div>
                                        </div>
                                    </div>
