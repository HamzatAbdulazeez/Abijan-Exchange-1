                                                ...
                                                <div class="walletaddy">
                                                    <b class="receive-address">
                                                        <span class="Ethereum-address Ethereum-address-controls walletinfo" style="display: none1;" id="walletinfo">
                                                            1MbvqXvfvqAnCKXdVeiLPXPDp4AE82eVhz
                            ...
                            <div class="accordion accordion_custom mb_50" id="accordion_ex">
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion_ex">
                                        <div class="card-body">
                                            <p>Transactions sent from wallets of other Naira Direct users are free.</p>

                                            <p>
                                                Transactions from other Ethereum wallets are subject to a deposit fee. The size of the fee changes depending on the current usage rate of the Ethereum blockchain, we automatically adjust this fee based
                                                on the current network congestion to make sure your transactions are confirmed as quickly as possible. The deposit fee is paid from your Naira Direct wallet when you receive a transaction.
                                            </p>
