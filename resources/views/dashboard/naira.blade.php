                        ...
                        <div class="white_card card_height_100 mb_30">
                                ...
                                <div class="box_header m-0">
                                    <div class="main-title">
                                        ...
                                        <ul class="nav nav-pills custom_bootstrap_nav">
                                            <li class="nav-item">
                                              <a class="nav-link active" href="#nairadiv" data-toggle="tab">Withdraw Naira</a>
                                            </li>
                                            <li class="nav-item">
                                              <a class="nav-link" href="naira_deposit"> Deposit Naira</a>
                                            </li>
                                            <li class="nav-item">
                                              <a class="nav-link" href="naira_transactions"> Transactions</a>
                                            </li>
                                          </ul>
                                    </div>
                            ...
                            <div class="white_card_body tab-pane fade active show" id="nairadiv">
                                <div class="exchange_widget">
                                            ...
                                            <label>Bank Account</label> <small style="float:right;"><a href="settings?type=bank"><i class="fas fa-edit"></i> Add/Edit Bank</a></small>
                                            <div class="input-group ">
                                                <select name="bank_name" id="bank_name" class="form-control nice_Select" style="display: none;">
                                                                                                                                               </select><div class="nice-select form-control nice_Select" tabindex="0"><span class="current"></span><div class="nice-select-search-box"><input type="text" class="nice-select-search" placeholder="Search..."></div><ul class="list"></ul></div>
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="trf_amount" class="form-control" id="trf_amount">
                                            </div>
                                            <div class="d-flex justify-content-between mt-3">
                                                ...
                                                <input type="hidden" name="fee_method" id="fee_method" value="percentage">
                                                <input type="hidden" name="balngn" id="balngn" value="0.00">
                                                <input type="hidden" name="above_amount" id="above_amount" value="10000">
                                            </div>
                                            ...
                                            <div class="d-flex justify-content-between mt-3 hidden" id="availBalwith">
                                                <p class="mb-0">Balance after this withdrawal</p>
                                                <h6 class="mb-0 ngnbal_upto balspanwith"></h6>
                                                
                                            </div>
                                        </div>
                                        <button type="button" name="with_submit" id="with_submit" class="btn_1 w-100">Withdraw Now <span class="loadingText fa fa-spinner fa-spin fa-2x" style="display:none;float:right;" id="loadingText_with"></span></button>
                                    </form>
                                                                    </div>
                            </div>
                            ...
                            <div class="accordion accordion_custom mb_50" id="accordion_ex">
                                <div class="card">
                                    ...
                                    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion_ex">
                                        <div class="card-body">
                                            <p>Withdrawal to bank accounts normally take about 10 to 30 minutes to be processed, on occasion it can take a few hours depending on the interbank network.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    ...
                                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion_ex">
                                        <div class="card-body">
                                            <p>No, you can't withdraw naira to someone's bank account. If you wish to send the money to someone else, please transfer to them through another means.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
