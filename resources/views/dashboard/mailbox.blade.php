                        ...
                        <div class="col-md-3">
                            <div class="email-sidebar white_box">
                                ...
                                <ul class="text-left mt-2">
                                    <li class="active"><a href="{{ route('mailbox.inbox') }}"><i class="ti-user"></i> <span>
                            ...
                            <div class="white_box QA_section mb_30">
                                ...
                                <div class="QA_table">
                                    ...
                                    <a href="javascript: void(0)" class="deletTop inbox" title="Delete message">
                                        ...
                                        <a href="javascript: void(0)" class="achieveMail inbox" title="Archive message">
                                ...
                                <div class="col-lg-12" style="display:none1">
                                    <div class="common_input mb_20">
                                        ...
                                        <button type="button" id="replybtnMsg" class="btn_1 w-100 col-md-5"><i
                                                class="ti-arrow-top-left"></i> Reply</button> <span
                                            class="col-md-2"></span><button type="submit" class="btn_2 w-100 col-md-5"
