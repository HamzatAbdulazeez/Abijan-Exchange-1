                            ...
                            <div class="tab-content">
                                <div class="white_card_body tab-pane fade active show" id="nairadiv">
                                    <div class="exchange_widget">
                                        <form name="mySettform" id="mySettform" method="POST" action="{{route('user.update.username')}}"  autocomplete="off">
                                            @csrf
                                            <div class="form-group thirdver">
                                            ...
                                            <button type="submit" name="" id="" class="btn_1 w-100 ">Update Phone Number <span class="loadingText fa fa-spinner fa-spin fa-2x" style="display:none;float:right;" id="loadingText_sett"></span></button><input type="hidden" id="prof" name="prof" value="questions">
                                        </form>
                                    </div>
                                </div>
